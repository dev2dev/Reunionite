...
#define SHKMyAppName			@"Reunionite"
#define SHKMyAppURL				@"http://rchampourlier.com/softroch/reunionite"
...
#define SHKFacebookKey				@"06008fc0fb60e2cc923251ae2799f7a0"
#define SHKFacebookSecret			@"b61e0de59491bce46744c77f433fd1a7"
 ...
 */
#define SHKTwitterConsumerKey		@"ctjcIfo7g6yddPcQE6PQw"
#define SHKTwitterSecret			@"IxcBaQiB0vrPtI7yvUwvHnkJrr0INRxxZouJl05gHFI"
#define SHKTwitterCallbackUrl		@"http://rchampourlier.com/softroch/reunionite/SHKTwitterCallbackUrl" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"softroch" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)

// Bit.ly (for shortening URLs on Twitter) - http://bit.ly/account/register - after signup: http://bit.ly/a/your_api_key
#define SHKBitLyLogin				@"softroch"
#define SHKBitLyKey					@"R_b98a447065fdb08bb4567ec238f96a03"
